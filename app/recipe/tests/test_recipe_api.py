...
def detail_url(recipe_id):
    """Create and return a reciple detail URL."""
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_partial_update(self):
        ...
        payload = {'title': 'New reciple title'}
        url = detail_url(recipe.id)
    ...
    def test_create_ingredient_on_update(self):
        ...
        payload = {'ingredients': [{'name': 'Sesame Seed'}]}
        url = detail_url(recipe.id)
        res = self.client.patch(url, payload, format='json')

        self.assertEqual(res.status_code, status.HTTP_200_OK)
        new_ingredient = Ingredient.objects.get(
            user=self.user, name='Sesame Seed')
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='Chicken Fried Steak')
        tag1 = Tag.objects.create(user=self.user, name='Vegain')
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='Chicen Cacciatore')
